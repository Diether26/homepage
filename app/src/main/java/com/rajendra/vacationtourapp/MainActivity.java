...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recentsDataList.add(new RecentsData("Repair",R.drawable.repair));
        recentsDataList.add(new RecentsData("Install",R.drawable.install));

        setRecentRecycler(recentsDataList);

        List<TopPlacesData> topPlacesDataList = new ArrayList<>();
        topPlacesDataList.add(new TopPlacesData("Repairman","Diether Seroylas","Rate",R.drawable.avatar));
        topPlacesDataList.add(new TopPlacesData("Installman","Diether Seroylas","Rate",R.drawable.avatar));
        topPlacesDataList.add(new TopPlacesData("Repairman","Diether Seroylas","Rate",R.drawable.avatar));
        topPlacesDataList.add(new TopPlacesData("Installman","Diether Seroylas","Rate",R.drawable.avatar));
        topPlacesDataList.add(new TopPlacesData("Repairman","Diether Seroylas","Rate",R.drawable.avatar));
        topPlacesDataList.add(new TopPlacesData("Installman","Diether Seroylas","Rate",R.drawable.avatar));
